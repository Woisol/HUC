...
function SlideBarOption(props, index) {
	...
	return (
		<a key={index} href={"#" + props.PageID} className="w-full overflow-hidden flex items-center rounded-2xl transition-all hover:bg-blue-300 hover:text-xl"> <img className="w-14 h-14 m-1" src={props.icon} alt={props.title} />{props.title}</a>
