...
export default function MainSwitch({ isMonitorRunning }) {// isMonitorRunning, setState
	...
	return (
		<div onContextMenu={(event) => { ipcRenderer.send("ContextMenu_MainSwitch"); }} className="absolute flex flex-col items-center h-48 duration-700 -translate-x-1/2 sm:flex-row left-1/2 w-fit -top-44 sm:-top-32 sm:left-10 sm:translate-x-0">
